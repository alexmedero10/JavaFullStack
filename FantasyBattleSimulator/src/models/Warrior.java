...
public class Warrior extends Entity {
    ...
    private final int valueActivateSpecialAbility = 5;

    public Warrior(String name, int health, int attack, int defend, String specialAbilityName, int specialAbility) {
